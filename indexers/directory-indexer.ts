...
export class DirectoryIndexer {
    ...
    constructor(public catalog: Catalog, opts: DirectoryIndexerOpts) {
    ...
    private includeFile(filename: string): boolean {
        return filename.endsWith(".md") || filename.endsWith(".mdx") || filename.endsWith(".txt") || filename.endsWith(".docx");
    }
